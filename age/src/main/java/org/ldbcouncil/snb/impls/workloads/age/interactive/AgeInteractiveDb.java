...
/**
 * LDBC SNB Interactive workload entry point for Apache AGE.
 *
 * Extends AgeDb (which sets up the connection) and registers all 29 operation handlers.
 * Use this class name in benchmark.properties:
