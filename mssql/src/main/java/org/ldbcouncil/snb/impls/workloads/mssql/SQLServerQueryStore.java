...
public class SQLServerQueryStore extends QueryStore {
    ...
    /**
     * Get prepared InsertQuery1 strings.
     * This is used for system requiring multiple Inserts.
     * @param operation InsertQuery1 operation containing parameter values
     * @return List of prepared InsertQuery1 strings
     */
    @Override
    public List<String> getInsert1Multiple(LdbcInsert1AddPerson operation) {
        ...
        for (LdbcInsert1AddPerson.Organization organization : operation.getWorkAt()) {
            list.add(prepare(
                    ...
                    ImmutableMap.of(
                        LdbcInsert1AddPerson.CREATION_DATE, SQLServerConverter.convertDateToOffsetDateTime(operation.getCreationDate()),
