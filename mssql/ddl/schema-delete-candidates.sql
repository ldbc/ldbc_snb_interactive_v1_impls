...
CREATE TABLE Person_Delete_candidates                (deletionDate datetimeoffset not null, id bigint not null);
CREATE TABLE Forum_Delete_candidates                 (deletionDate datetimeoffset not null, id bigint not null);
CREATE TABLE Comment_Delete_candidates               (deletionDate datetimeoffset not null, id bigint not null);
CREATE TABLE Post_Delete_candidates                  (deletionDate datetimeoffset not null, id bigint not null);
CREATE TABLE Person_likes_Comment_Delete_candidates  (deletionDate datetimeoffset not null, src bigint not null, trg bigint not null);
CREATE TABLE Person_likes_Post_Delete_candidates     (deletionDate datetimeoffset not null, src bigint not null, trg bigint not null);
CREATE TABLE Forum_hasMember_Person_Delete_candidates(deletionDate datetimeoffset not null, src bigint not null, trg bigint not null);
CREATE TABLE Person_knows_Person_Delete_candidates   (deletionDate datetimeoffset not null, src bigint not null, trg bigint not null);
...
CREATE TABLE Forum_Delete_candidates_unique(deletionDate datetimeoffset not null, id bigint not null);
