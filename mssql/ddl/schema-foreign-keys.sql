...
ALTER TABLE Message ADD FOREIGN KEY (ParentMessageId) REFERENCES Message(MessageId) ON DELETE CASCADE;
ALTER TABLE Message_hasTag_Tag ADD FOREIGN KEY (MessageId) REFERENCES Message(MessageId) ON DELETE CASCADE;
...
ALTER TABLE Person_likes_Message ADD FOREIGN KEY (MessageId) REFERENCES Message(MessageId) ON DELETE CASCADE;
