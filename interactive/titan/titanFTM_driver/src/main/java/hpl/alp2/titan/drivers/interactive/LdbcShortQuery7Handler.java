...
public class LdbcShortQuery7Handler implements OperationHandler<LdbcShortQuery7MessageReplies,TitanFTMDb.BasicDbConnectionState> {
    ...
    @Override
    public void executeOperation(final LdbcShortQuery7MessageReplies operation,TitanFTMDb.BasicDbConnectionState dbConnectionState,ResultReporter resultReporter) {
