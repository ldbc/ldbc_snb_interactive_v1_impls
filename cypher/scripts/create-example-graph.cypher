...
CREATE
  ...
  (pA)-[:STUDY_AT]->(cambridge),
  (pD)-[:STUDY_AT]->(cambridge),
  (pE)-[:STUDY_AT]->(cambridge),
  (pA)-[:WORKS_AT]->(softengco),
  // Places
  ...
  // Messages,
  (p1:Message:Post    {id: 0, creationDate: datetime('2011-10-10T11:05:56.000+00:00'), length: 24, content: 'We should go to Hautacam', language: 'en'}),
