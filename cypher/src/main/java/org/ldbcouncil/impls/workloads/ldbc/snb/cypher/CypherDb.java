...
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery10Result;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery11;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery11Result;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery12;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery12Result;
...
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery14Result;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery1Result;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery2;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery2Result;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery3;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery3Result;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery4;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery4Result;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery5;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery5Result;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery6;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery6Result;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery7;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery7Result;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery8;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery8Result;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery9;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcQuery9Result;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery1PersonProfile;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery1PersonProfileResult;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery2PersonPosts;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery2PersonPostsResult;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery3PersonFriends;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery3PersonFriendsResult;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery4MessageContent;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery4MessageContentResult;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery5MessageCreator;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery5MessageCreatorResult;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery6MessageForum;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery6MessageForumResult;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery7MessageReplies;
import org.ldbcouncil.driver.workloads.ldbc.snb.interactive.LdbcShortQuery7MessageRepliesResult;
...
import org.ldbcouncil.impls.workloads.ldbc.snb.cypher.operationhandlers.CypherIC13OperationHandler;
import org.ldbcouncil.impls.workloads.ldbc.snb.cypher.operationhandlers.CypherListOperationHandler;
import org.ldbcouncil.impls.workloads.ldbc.snb.cypher.operationhandlers.CypherSingletonOperationHandler;
import org.ldbcouncil.impls.workloads.ldbc.snb.cypher.operationhandlers.CypherUpdateOperationHandler;
    ...
    public static class InteractiveQuery3 extends CypherListOperationHandler<LdbcQuery3,LdbcQuery3Result>
    {
        ...
        public Map<String, Object> getParameters( LdbcQuery3 operation )
        {
            ...
            return ImmutableMap.<String, Object>builder()
                               ...
                               .put( LdbcQuery3.START_DATE, operation.startDate().getTime() )
                               .put( "endDate", endDate.getTime() )
                               .put( LdbcQuery3.LIMIT, operation.limit() )
                               .build();
        }
    ...
    public static class InteractiveQuery4 extends CypherListOperationHandler<LdbcQuery4,LdbcQuery4Result>
    {
        ...
        public Map<String, Object> getParameters( LdbcQuery4 operation )
        {
            ...
            return ImmutableMap.<String, Object>builder()
                               ...
                               .put( "endDate", endDate.getTime() )
                               .put( LdbcQuery4.LIMIT, operation.limit() )
                               .build();
        }
    ...
    public static class Update1AddPerson extends CypherUpdateOperationHandler<LdbcUpdate1AddPerson>
    {
        ...
        public Map<String, Object> getParameters( LdbcUpdate1AddPerson operation )
        {
            ...
            return ImmutableMap.<String, Object>builder()
                               ...
                               .put( LdbcUpdate1AddPerson.GENDER, operation.gender() )
                               .put( LdbcUpdate1AddPerson.BIRTHDAY, operation.birthday().getTime() )
                               .put( LdbcUpdate1AddPerson.CREATION_DATE, operation.creationDate().getTime() )
                               .put( LdbcUpdate1AddPerson.LOCATION_IP, operation.locationIp() )
                               .put( LdbcUpdate1AddPerson.BROWSER_USED, operation.browserUsed() )
                               .put( LdbcUpdate1AddPerson.CITY_ID, operation.cityId() )
                               .put( LdbcUpdate1AddPerson.LANGUAGES, operation.languages() )
                               .put( LdbcUpdate1AddPerson.EMAILS, operation.emails() )
                               .put( LdbcUpdate1AddPerson.TAG_IDS, operation.tagIds() )
    ...
    public static class Update4AddForum extends CypherUpdateOperationHandler<LdbcUpdate4AddForum>
    {
        ...
        public Map<String, Object> getParameters( LdbcUpdate4AddForum operation )
        {
            return ImmutableMap.<String, Object>builder()
                               ...
                               .put( LdbcUpdate4AddForum.MODERATOR_PERSON_ID, operation.moderatorPersonId() )
                               .put( LdbcUpdate4AddForum.TAG_IDS, operation.tagIds() )
                               .build();
        }
    }
    ...
    public static class Update6AddPost extends CypherUpdateOperationHandler<LdbcUpdate6AddPost>
    {
        ...
        public Map<String, Object> getParameters( LdbcUpdate6AddPost operation )
        {
            return ImmutableMap.<String, Object>builder()
                               ...
                               .put( LdbcUpdate6AddPost.LOCATION_IP, operation.locationIp() )
                               .put( LdbcUpdate6AddPost.BROWSER_USED, operation.browserUsed() )
                               .put( LdbcUpdate6AddPost.LANGUAGE, operation.language() )
                               .put( LdbcUpdate6AddPost.CONTENT, operation.content() )
                               .put( LdbcUpdate6AddPost.LENGTH, operation.length() )
                               .put( LdbcUpdate6AddPost.AUTHOR_PERSON_ID, operation.authorPersonId() )
                               .put( LdbcUpdate6AddPost.FORUM_ID, operation.forumId() )
                               .put( LdbcUpdate6AddPost.COUNTRY_ID, operation.countryId() )
                               .put( LdbcUpdate6AddPost.TAG_IDS, operation.tagIds() )
                               .build();
        }
    }
    ...
    public static class Update7AddComment extends CypherUpdateOperationHandler<LdbcUpdate7AddComment>
    {
        ...
        public Map<String, Object> getParameters( LdbcUpdate7AddComment operation )
        {
            return ImmutableMap.<String, Object>builder()
                               ...
                               .put( LdbcUpdate7AddComment.BROWSER_USED, operation.browserUsed() )
                               .put( LdbcUpdate7AddComment.CONTENT, operation.content() )
                               .put( LdbcUpdate7AddComment.LENGTH, operation.length() )
                               .put( LdbcUpdate7AddComment.AUTHOR_PERSON_ID, operation.authorPersonId() )
                               .put( LdbcUpdate7AddComment.COUNTRY_ID, operation.countryId() )
                               .put( LdbcUpdate7AddComment.REPLY_TO_POST_ID, operation.replyToPostId() )
                               .put( LdbcUpdate7AddComment.REPLY_TO_COMMENT_ID, operation.replyToCommentId() )
                               .put( LdbcUpdate7AddComment.TAG_IDS, operation.tagIds() )
                               .build();
        }
    }
