	...
	weights(we, score) as (
		select e,sum(score) from (
			select e, pid1, pid2, max(score) as score from (
				select e, 1 as score, p1.ps_postid as pid1, p2.ps_postid as pid2 from edges, post p1, post p2 where (p1.ps_creatorid=e[1] and p2.ps_creatorid=e[2] and p2.m_c_replyof=p1.ps_postid and p1.m_c_replyof is null)
				union all
				select e, 1 as score, p1.ps_postid as pid1, p2.ps_postid as pid2 from edges, post p1, post p2 where (p1.ps_creatorid=e[2] and p2.ps_creatorid=e[1] and p2.m_c_replyof=p1.ps_postid and p1.m_c_replyof is null)
				union all
				select e, 0.5 as score, p1.ps_postid as pid1, p2.ps_postid as pid2 from edges, post p1, post p2 where (p1.ps_creatorid=e[1] and p2.ps_creatorid=e[2] and p2.m_c_replyof=p1.ps_postid and p1.m_c_replyof is not null)
				union all
				select e, 0.5 as score, p1.ps_postid as pid1, p2.ps_postid as pid2  from edges, post p1, post p2 where (p1.ps_creatorid=e[2] and p2.ps_creatorid=e[1] and p2.m_c_replyof=p1.ps_postid and p1.m_c_replyof is not null)
