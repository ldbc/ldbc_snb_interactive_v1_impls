...
select ctry_name, mm, p_gender, age, t_name, count(*) as cnt 
from
	(
	...
	post_tag, tag
where ps_postid=pst_postid and t_tagid=pst_tagid
group by ctry_name, mm, p_gender, age, t_name
having count(*) > --5--
order by cnt desc, t_name asc,  age asc, p_gender asc, mm asc, ctry_name asc
limit 100;
