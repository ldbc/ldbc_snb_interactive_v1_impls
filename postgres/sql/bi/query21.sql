select zombielikes.ps_creatorid, zombielikes.cnt as zmb, reallikes.cnt as real, 
...
having count(*) <  extract(day from (--2-- - p_creationdate))/30) noproducer, post, likes
...
where zombielikes.ps_creatorid = reallikes.ps_creatorid
  and p.p_placeid = ctry_city and ctry_name = '--1--'
