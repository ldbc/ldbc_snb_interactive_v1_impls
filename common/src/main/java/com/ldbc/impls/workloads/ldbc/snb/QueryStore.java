...
public abstract class QueryStore {
    ...
    public enum QueryType {
        ...
        InteractiveQuery1("query1"),
        InteractiveQuery2("query2"),
        InteractiveQuery3("query3"),
        InteractiveQuery4("query4"),
        InteractiveQuery5("query5"),
        InteractiveQuery6("query6"),
        InteractiveQuery7("query7"),
        InteractiveQuery8("query8"),
        InteractiveQuery9("query9"),
        InteractiveQuery10("query10"),
        InteractiveQuery11("query11"),
        InteractiveQuery12("query12"),
        InteractiveQuery13("query13"),
        InteractiveQuery14("query14"),
